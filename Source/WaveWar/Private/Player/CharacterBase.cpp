...
AActor* ACharacterBase::FindPlayerStart() const
{
	AActor* PlayerStart = UGameplayStatics::GetActorOfClass(GetWorld(), APlayerStart::StaticClass());
	return PlayerStart;
}

void ACharacterBase::RespawnAtPlayerStart()
{
...
void ACharacterBase::SetCheckpointLocation(FVector NewCheckpointLocation)
{
	SafePlayerLocation();
	CheckpointLocation = NewCheckpointLocation;
}

void ACharacterBase::SafePlayerLocation()
{
